...
public class PlayerAnimator : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        jumpPSettings.startColor = new ParticleSystem.MinMaxGradient(mapManager.SceneData.foregroundColor);
        ParticleSystem.MainModule landPSettings = _landParticle.main;
        landPSettings.startColor = new ParticleSystem.MinMaxGradient(mapManager.SceneData.foregroundColor);
    }
